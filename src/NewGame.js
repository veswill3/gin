...
class NewGame extends Component {
  ...
  handleNewgame = () => {
    ...
    this.props.newgameHandler(player1, player2, options);
  }
  ...
  render() {
    ...
    const disableStart = !player1 || !player2 || !ginBonus || !bigGinBonus || !undercutBonus || !winLimit;
    return (
      <Layout
        leftAction={<Button fluid onClick={this.handleClear}>Reset</Button>}
        rightAction={<Button fluid primary onClick={this.handleNewgame} disabled={disableStart}>Start</Button>}
      >
        <Form>
          <h2>Player Info</h2>
          <Form.Group>
